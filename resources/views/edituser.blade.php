    ...
    <div class="container">
        <div class="row mt-5 justify-content-center">
            <div class="col-md-10">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{url('user/uptade') }}" method="post">
                            @csrf
                            <input value="{{ $user->id}}" type="hidden" name="name" id="name" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <inpu value="{{$user->email}}" type="email" name="email" id="email" class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <inpu valuet="{{$user->telepon}}" type="text" name="telepon" id="telepon" class="form-control">
                            </div>
